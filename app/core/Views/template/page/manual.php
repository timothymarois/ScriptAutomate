<div class="output_view" style="overflow: hidden; position: relative; border-top: 1px solid rgb(231, 231, 231); z-index: 9;width:100%;height:100%;padding:10px; border-top: 1px solid rgb(58, 58, 58);border-top: 1px solid rgb(33, 33, 33);">
    ...
    <iframe id="systemview" name="systemview" src="about:blank" scrolling="yes" frameborder="0" style="border: 1px solid rgb(231, 231, 231); overflow-x: hidden;background:#171717;border-radius:4px; border: 1px solid rgb(78, 78, 78);border: 1px solid rgb(53, 53, 53);"></iframe>
